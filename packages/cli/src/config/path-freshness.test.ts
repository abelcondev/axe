...
// Regression guard: `AXE_HOME` is resolved by `preResolveHomeEnvOverrides()`
...
// across callers. Each test mutates `process.env.AXE_HOME` post-load and
...
describe('settings/trustedFolders path getters are lazy', () => {
  ...
  it('getTrustedFoldersPath() reflects AXE_HOME set after module load', () => {
