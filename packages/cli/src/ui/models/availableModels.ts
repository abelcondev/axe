...
const CACHED_AXE_OAUTH_MODELS: AvailableModel[] = AXE_OAUTH_MODELS.map(
  (model) => ({
    id: model.id,
...
function getAxeOAuthModels(): readonly AvailableModel[] {
  return CACHED_AXE_OAUTH_MODELS;
}
