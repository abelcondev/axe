...
9. **Verify** — A task is done only when every Gherkin scenario is satisfied: automated tests green, \`(manual)\` scenarios confirmed in the running app. Then set the task's \`status\` to \`done\` before moving on.
