...
/**
 * Converter for Gemini extensions to Axe format.
 */
...
/**
 * Converts a Gemini extension config to Axe format.
...
/**
 * Converts a complete Gemini extension package to Axe format.
